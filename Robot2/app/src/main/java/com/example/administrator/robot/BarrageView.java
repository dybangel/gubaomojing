...
import com.example.administrator.robot.Nlp;
...
public class BarrageView extends RelativeLayout {
    ...
    private int minSize = 30;       //最小文字大小，dp15;
    ...
    public static boolean isfirstloaddb=true;
...
//                }
                ...
                for(int i = 0;i < questions.length; i ++){
                        ...
                        if(temp==questions[i].toString()){
                            ans=answers[i].toString();
...
//                }
    ...
    public  static void initData(){
        ...
        //cleanlist();
           ...
           for(int i = 0;i < questions.length; i ++){
               itemText.add(questions[i].toString());
           }
