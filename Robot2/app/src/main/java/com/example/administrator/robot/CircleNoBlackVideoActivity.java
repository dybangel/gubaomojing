...
public class CircleNoBlackVideoActivity extends AppCompatActivity {
    private CircleNoBlackVideoActivity.OnClickActionListener mClick = null;
    // 为接口设置监听器
    public void setOnClickActionListener(CircleNoBlackVideoActivity.OnClickActionListener down) {
        mClick = down;
    }
    //定义接口
 ...
 //   public class CircleNoBlackVideoActivity extends RelativeLayout {
    public static final String TAG = CircleNoBlackVideoActivity.class.getSimpleName();


    public static String path1 = Environment.getExternalStorageDirectory() + File.separator + "1.mp4";
    public static String path2 = Environment.getExternalStorageDirectory() + File.separator + "2.mp4";
    public static String path3 = Environment.getExternalStorageDirectory() + File.separator + "3.mp4";
        ...
        public void run() {
            ...
            try {
                if (mIndex == 0) {
                    ...
                    mCurrentMediaPlayer.setOnPreparedListener(
