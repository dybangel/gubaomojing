package com.example.administrator.robot.Socket;
...
//        }
        ...
        if (intent.getAction().equals("android.intent.action.BOOT_COMPLETED") ||
                ...
                intent.getAction().equals("com.example.administrator.robot.Socket.receiver")) {
            if (!MyApplication.isServiceWork(context, "com.example.administrator.robot.Socket.SocketService")) {
